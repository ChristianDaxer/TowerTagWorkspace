...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        public static bool CloseConnection(IPlayer kickPlayer)
        {
            if (!VerifyCanUseNetwork())
            {
                return false;
        ...
        /// Internal to send an RPC on given PhotonView. Do not call this directly but use: PhotonView.RPC!
        /// </summary>
        internal static void RPC(PhotonView view, string methodName, IPlayer targetPlayer, bool encrpyt, params object[] parameters)
        {
            if (!VerifyCanUseNetwork())
            {
                return;
        ...
        public static void PrepareLoadLevel(string sceneName) {
            if (PhotonNetwork.AutomaticallySyncScene) {
                SetLevelInPropsIfSynced(sceneName);
            }
