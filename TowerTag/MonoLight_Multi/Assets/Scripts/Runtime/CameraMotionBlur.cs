...
namespace OwnUnityStandardAssets.ImageEffects
{
    ...
    public class CameraMotionBlur : UnityStandardAssets.ImageEffects.PostEffectsBase
    {
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination) {
            ...
            velBuffer.vrUsage = source.vrUsage;
            int tileWidth = 1;
            int tileHeight = 1;
