...
namespace Network {
    public class SingletonMonoBehaviourPunCallbacks<T> : SingletonMonoBehaviour<T>, IConnectionCallbacks,
        IMatchmakingCallbacks, IInRoomCallbacks, ILobbyCallbacks where T : SingletonMonoBehaviourPunCallbacks<T> {
        ...
        /// </summary>
        /// <remarks>
        /// While in the lobby, the room list is automatically updated in fixed intervals (which you can't modify in the public cloud).
        ...
        /// <summary>
        /// Called when a remote player entered the room. This Player is already added to the player list.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        ///
        /// <param name="target">Contains Player that changed.</param>
