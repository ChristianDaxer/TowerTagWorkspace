...
namespace ZG {
    ...
    public class GridLayoutGroupEx : LayoutGroup {
        ...
        [SerializeField] internal int _constraintCount;
        ...
        [SerializeField] internal bool _childScaleWidth;
        ...
        [SerializeField] internal bool _childScaleHeight;
        ...
        /// <param name="startRectChildrenIndex"></param>
        /// <param name="rectChildrenCount"></param>
        ...
        private void __CalcAlongAxis(
            ...
            for (int i = 0; i < rectChildrenCount; i++) {
                RectTransform child = rectChildren[i + startRectChildrenIndex];
