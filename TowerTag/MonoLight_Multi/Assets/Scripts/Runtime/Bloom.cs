...
namespace OwnUnityStandardAssets.ImageEffects
{
    ...
    public class Bloom : UnityStandardAssets.ImageEffects.PostEffectsBase
    {
        ...
        public void OnDisable()
        {
            ...
            {
                DestroyImmediate(blurAndFlaresMaterial);
        ...
        public void OnRenderImage (RenderTexture source, RenderTexture destination)
        {
            ...
            if (quality > BloomQuality.Cheap) {
                ...
                rtDown4.vrUsage = source.vrUsage;
            ...
            secondQuarterRezColor.vrUsage = source.vrUsage;
            ...
            if (lensflareIntensity > Mathf.Epsilon)
			{
                ...
                rtFlares4.vrUsage = source.vrUsage;
            ...
            if (quality > BloomQuality.Cheap)
			{
                ...
                halfRezColorUp.vrUsage = source.vrUsage;
