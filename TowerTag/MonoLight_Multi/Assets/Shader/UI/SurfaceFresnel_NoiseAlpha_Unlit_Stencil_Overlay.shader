...
Shader "_OwnShader/SurfaceFresnel_NoiseAlpha_Unlit_Stencil_Overlay" {
	Properties {
		...
		_MinStencilAlpha("Min Stencil Alpha", float) = 0
	}
	SubShader {
		...
		// Unlit
		#pragma surface surf NoLighting fullforwardshadows vertex:vert tessellate:tess tessphong:_PhongTess alpha:fade nolightmap noforwardadd
