...
Shader "_OwnShader/Effects/FPS_Pack/FPSGlass_SinglePass" {
Properties {
...
v2f vert (appdata_t v)
{
	...
	o.vertex = UnityObjectToClipPos(v.vertex);
		...
		o.projPos = ComputeGrabScreenPos(UnityObjectToClipPos(v.vertex));
	...
	o.uvgrab = ComputeGrabScreenPos(UnityObjectToClipPos(v.vertex));
