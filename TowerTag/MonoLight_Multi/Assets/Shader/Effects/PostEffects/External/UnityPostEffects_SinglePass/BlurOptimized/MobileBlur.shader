...
Shader "Hidden/FastBlur" {
	...
	CGINCLUDE
		...
		v2f_withBlurCoordsSGX vertBlurHorizontalSGX (appdata_img v)
		{
			...
			o.offs[0] = uv.xyxy + coords * half4(1.0h,1.0h,-1.0h,-1.0h);
			coords += netFilterWidth.xyxy;
			o.offs[1] = uv.xyxy + coords * half4(1.0h,1.0h,-1.0h,-1.0h);
			coords += netFilterWidth.xyxy;
			o.offs[2] = uv.xyxy + coords * half4(1.0h,1.0h,-1.0h,-1.0h);
