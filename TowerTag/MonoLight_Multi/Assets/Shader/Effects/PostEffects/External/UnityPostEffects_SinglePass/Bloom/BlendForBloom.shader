...
Shader "Hidden/BlendForBloom" {
	...
	v2f_mt vertMultiTap( appdata_img v ) {
		...
		float2 uv = UnityStereoScreenSpaceUVAdjust(v.texcoord.xy, _MainTex_ST);
		o.uv[4] = uv;
		o.uv[0] = uv + _MainTex_TexelSize.xy * 0.5;
		o.uv[1] = uv - _MainTex_TexelSize.xy * 0.5;
		o.uv[2] = uv - _MainTex_TexelSize.xy * half2(1, -1) * 0.5;
		o.uv[3] = uv + _MainTex_TexelSize.xy * half2(1, -1) * 0.5;
