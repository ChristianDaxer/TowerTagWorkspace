...
namespace SOEventSystem {
    ...
    public class SharedReferenceDrawer : PropertyDrawer {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            // Get properties
            SerializedProperty useConstant = property.FindPropertyRelative("_usePrivateValue");
            SerializedProperty constantValue = property.FindPropertyRelative("_privateValue");
            SerializedProperty variable = property.FindPropertyRelative("_shared");
